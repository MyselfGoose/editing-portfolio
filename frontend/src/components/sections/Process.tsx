...
const FRAMES: ReadonlyArray<ProcessFrame> = [
  {
    ...
    craft: "Editorial",
    title: "We find the strongest moments",
    copy: "Every wedding film begins in the footage. We review the day end to end and build selects that carry the emotion — glances, vows, and the rooms in between.",
  ...
  },
  {
    ...
    copy: "We lock length, rhythm, and emotional arc so the cut breathes. Pacing comes before polish.",
    media: {
      type: "mux",
  ...
  },
  {
    ...
    eyebrow: "COLOR / GRADE",
    craft: "Color",
    title: "The grade finds the mood",
    copy: "Assembly, pacing, and grade speak one language. Contrast, temperature, and grain settle until the day feels true on every screen.",
  ...
  },
  {
    ...
    copy: "Sound, final polish, and delivery masters. Ready for the reception screen, the share link, and long-term archive.",
